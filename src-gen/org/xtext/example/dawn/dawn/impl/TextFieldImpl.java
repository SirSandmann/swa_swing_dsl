 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.dawn.dawn.impl.TextFieldImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextFieldImpl extends ComponentImpl implements TextField
{
  ...
  {
    return DawnPackage.Literals.TEXT_FIELD;
  }
  ...
  public NotificationChain basicSetText(TextAttribute newText, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DawnPackage.TEXT_FIELD__TEXT, oldText, newText);
  ...
  public void setText(TextAttribute newText)
  {
    if (newText != text)
    {
      ...
      if (text != null)
        msgs = ((InternalEObject)text).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DawnPackage.TEXT_FIELD__TEXT, null, msgs);
      if (newText != null)
        msgs = ((InternalEObject)newText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DawnPackage.TEXT_FIELD__TEXT, null, msgs);
      msgs = basicSetText(newText, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DawnPackage.TEXT_FIELD__TEXT, newText, newText));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DawnPackage.TEXT_FIELD__TEXT:
